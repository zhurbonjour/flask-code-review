...
# в отдельный слой. В данном случае применим паттерн "Репозиторий"
# для обращения к базе данных. Так же следует поступить и с обращением
# к редису. Пусть функции роутеров будут маленькими объектами, которые
...
# Так же следует применять Репозиторий и UnitOfWork
